...
public class HiddenSongManager : MonoBehaviour
{
    public static HiddenSongManager instance;
    ...
    [SerializeField] private AudioSource freedom_Dive;
    ...
    int HiddenSongTime
    {
        ...
        set
        {
            ...
            {
                hiddenSongTime = value;
                HiddenSongText(hiddenSongTime);
            }
    ...
    void Start()
    {
        freedom_Dive.pitch = PlayerPrefs.GetFloat("SpeedRate");
        freedom_Dive.time = 0;
        freedom_Dive.Play();
    ...
    {
        for (int i = HiddenSongTime; i >= 0; i--)
        {
            HiddenSongTime = i;
    ...
    void SongEnd()
    {
        if (score > PlayerPrefs.GetInt("HiddenHighScore") && Time.timeScale == 1)
        {
            PlayerPrefs.SetInt("HiddenHighScore", score);
        }
    ...
    public void Pause()
    {
        ...
        {
            isPause = true;
            pause.IsPause(stopPanel, freedom_Dive);
        }
    }
    ...
    {
        pause.CallContinue(stopPanel, freedom_Dive);
        isPause = false;
    }
}