...
public class Song3Manager : MonoBehaviour
{
    public static Song3Manager instance;
    ...
    [SerializeField] private AudioSource egoRock;
    ...
    void Start()
    {
        egoRock.pitch = PlayerPrefs.GetFloat("SpeedRate");
        egoRock.time = 0;
        egoRock.Play();
    ...
    void SongEnd()
    {
        if (score > PlayerPrefs.GetInt("HighScore3") && Time.timeScale == 1)
        {
    ...
    public void Pause()
    {
        ...
        {
            isPause = true;
            pause.IsPause(stopPanel, egoRock);
        }
    }
    ...
    {
        pause.CallContinue(stopPanel, egoRock);
        isPause = false;
    }
}