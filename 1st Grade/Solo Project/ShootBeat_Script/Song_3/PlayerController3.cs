...
public class PlayerController3 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Song3Manager.instance.isPause == false)
            Press();
    ...
    void Press()
    {
        if (Input.GetKeyDown(left))
        {
            LeftPress();
            KeySound();
            GameObject laser = Song3Manager.instance.LaserGet();
    ...
    void TopPress()
    {
        ...
        if (closestObject != null)
        {
            ...
            if (distance <= 0.4f * Time.timeScale) //40ms = 0.4
            {
                Efc(closestObject);
                Perfect();
                Song3Manager.instance.noteDel(closestObject);
                ComboUp();
            }
    ...
    public void Perfect()
    {
        Song3Manager.instance.Score += 1004;
        delTime = 0.25f;
        Song3Manager.instance.perfect++;
    ...
    void Good()
    {
        Song3Manager.instance.Score += 669;
        delTime = 0.25f;
        Song3Manager.instance.good++;
        judgeTexts[0].enabled = false;
    ...
    void Bad()
    {
        Song3Manager.instance.Score += 334;
        delTime = 0.25f;
        Song3Manager.instance.bad++;
        judgeTexts[0].enabled = false;
        judgeTexts[1].enabled = false;
    ...
    IEnumerator EfcDel(GameObject delefc)
    {
        ...
        Song3Manager.instance.EfcDel(delefc);
    }

    void Efc(GameObject note)
    {
        GameObject efc = Song3Manager.instance.EfcGet();
