...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Song2Manager.instance.isPause == false)
            Press();
    ...
    void Press()
    {
        if (Input.GetKeyDown(left))
        {
            LeftPress();
            KeySound();
            GameObject laser = Song2Manager.instance.LaserGet();
    ...
    void TopPress()
    {
        ...
        if (closestObject != null)
        {
            ...
            if (distance <= 0.4f * Time.timeScale) //40ms = 0.4
            {
                Efc(closestObject);
                Perfect();
                Song2Manager.instance.noteDel(closestObject);
                ComboUp();
            }
    ...
    public void Perfect()
    {
        Song2Manager.instance.Score += 1917;
        delTime = 0.25f;
        Song2Manager.instance.perfect++;
    ...
    void Good()
    {
        Song2Manager.instance.Score += 1278;
        delTime = 0.25f;
        Song2Manager.instance.good++;
        judgeTexts[0].enabled = false;
    ...
    void Bad()
    {
        Song2Manager.instance.Score += 639;
        delTime = 0.25f;
        Song2Manager.instance.bad++;
        judgeTexts[0].enabled = false;
        judgeTexts[1].enabled = false;
    ...
    IEnumerator EfcDel(GameObject delefc)
    {
        ...
        Song2Manager.instance.EfcDel(delefc);
    }

    void Efc(GameObject note)
    {
        GameObject efc = Song2Manager.instance.EfcGet();
